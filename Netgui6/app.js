...
function crearNombreEnPlano(nombre, x, y, z) {
    ...
    grupo.object3D.position.set(x, y+4, z);
...
AFRAME.registerComponent("pausa-reproducir", {
    ...
    setPause:function() {
        ...
        console.log("eeeeewse" + document.querySelector('[envio-paquetes]'));
        console.log("queteeeeeealll"+document.querySelector('[envio-paquetes]').components);
...
AFRAME.registerComponent("simulacro",{
    ...
    agregarControles: function(){
        ...
        botonpausaReproducir.object3D.position.set(0, -2, -4)
        botonpausaReproducir.setAttribute("material", {src: "#pausa"});
        botonpausaReproducir.setAttribute("pausa");
